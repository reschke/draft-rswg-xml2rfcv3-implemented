...
all: \
	...
	draft-rswg-xml2rfcv3-implemented.txt \
...
allhtml: \
	draft-rswg-xml2rfcv3-implemented.redxml \
	xml2rfcv3-annotated.rng \
	draft-rswg-xml2rfcv3-implemented.html

xml2rfc.all: \
	draft-rswg-xml2rfcv3-implemented.xml xml2rfcv3-annotated.rng
...
xml2rfcv3-annotated.rng: xml2rfcv3.rng annotate-rng.xslt draft-rswg-xml2rfcv3-implemented.xml
	$(XSLT) $< annotate-rng.xslt doc=draft-rswg-xml2rfcv3-implemented.xml > $@
...
xml2rfcv3-spec-deprecated.xml: xml2rfcv3.rng rng2xml2rfc.xslt
	$(XSLT) $< rng2xml2rfc.xslt voc=v3 specsrc=draft-rswg-xml2rfcv3-implemented.xml deprecated=yes > $@
...
draft-rswg-xml2rfcv3-implemented.xml: xml2rfcv3-spec.xml xml2rfcv3-spec-deprecated.xml xml2rfcv3.rnc.folded differences-from-v2.txt
	cp -v $@ $@.bak
...
clean:
	rm -f SVG-1.2-RFC.rnc SVG-1.2-RFC.rng draft-rswg-xml2rfcv3-implemented.txt draft-rswg-xml2rfcv3-implemented.html \
		draft-rswg-xml2rfcv3-implemented.redxml draft-rswg-xml2rfcv3-implemented.unpg.txt differences-from-v2.txt \
